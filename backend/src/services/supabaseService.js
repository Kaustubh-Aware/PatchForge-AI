...
// ==============================================================================
// All scan lifecycles, repositories, normalized vulnerabilities, and aggregate
// stats persist directly to Supabase PostgreSQL database tables.
// ==============================================================================
        ...
        for (const pkg of vulnerablePackages) {
            ...
            for (const vuln of vulns) {
                ...
                const vulnRecord = {
                    ...
                    ecosystem: scanReport.ecosystem || "npm",
